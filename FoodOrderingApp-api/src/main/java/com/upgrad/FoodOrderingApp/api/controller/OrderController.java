...
public class OrderController {
    ...
    /*End point to find coupon details by coupon name based on authorization chack through access-token */
    ...
    /* Endpoint to find orders by customer based on the authorization through access-token */
    ...
    /*Endpoint to create new order based on authorization through access-token */
